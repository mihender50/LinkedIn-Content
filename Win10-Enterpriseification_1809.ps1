...
.DESCRIPTION
    ...
    Built and validated on Win10 1809 ONLY.

 

.EXAMPLE

    .\Win10-Enterpriseification_1809.ps1
...
.NOTES
    ...
    1.0.0 - (11-19-2018) Script created

 

.NOTES

    FileName:    Win10-Enterpriseification_1809.ps1
...
Configuration Enterpriseification1809 {
...
# 1809 AppXProvisionedPackage List
...
$AppList =     #"Microsoft.BingWeather",                 
               ...
               #"Microsoft.HEIFImageExtension", <-- New 1809                  
               ...
               #"Microsoft.VP9VideoExtensions",   <-- New 1809         

                "Microsoft.Wallet",

               #"Microsoft.WebMediaExtensions",  <-- New 1809

               #"Microsoft.WebpImageExtension",  <-- New 1809                 
               ...
               #"Microsoft.Todos", <-- New 1809

               #"Microsoft.Whiteboard",  <-- New 1809

                #AppXpackages

                #"Microsoft.Windows.CloudExperienceHost",          <--Unable to Remove

                #"Microsoft.AAD.BrokerPlugin",                     <--Unable to Remove

                #"Microsoft.Windows.ShellExperienceHost",          <--Unable to Remove
...
Enterpriseification1809 -output C:\AdminCfg
