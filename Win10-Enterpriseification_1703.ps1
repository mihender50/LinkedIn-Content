...
.DESCRIPTION
    ...
    Built and validated on Win10 1703 ONLY.
 
.EXAMPLE
    .\Win10-Enterpriseification_1703.ps1
...
Configuration Enterpriseification1703 {
...
TestScript = {
# 1703 AppXProvisionedPackage List
...
"Removing Package: $PackageFullName" |out-file C:\admincfg\UninstallAppXPackages.txt -append
# 1607 & 1703 Doesnt support -Allusers 
#remove-AppxPackage -package $PackageFullName.trim() -AllUsers
(Get-AppxPackage -AllUsers | Where-Object -property PackageName -eq $PackageFullName) | remove-AppxPackage
...
Enterpriseification1703 -output C:\AdminCfg
